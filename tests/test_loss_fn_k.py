import torch
import pytest
from langesim_optim import loss_fn_k, device, char_fn, FT_pdf  # Import necessary functions and classes from your module
...
def test_loss_fn_k():
    ...
    # Call the function
    loss_value = loss_fn_k(xf, kf, ki, device=device, scale=scale, kFsteps=kFsteps, x_steps=x_steps)
